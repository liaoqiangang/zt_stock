...
<head>
	...
	<link href="<%=basePath%>resources/statics/simpleboot/themes/flat/theme.min.css" rel="stylesheet">
    <link href="<%=basePath%>resources/statics/simpleboot/css/simplebootadmin.css" rel="stylesheet">
    <link href="<%=basePath%>resources/statics/js/artDialog/skins/default.css" rel="stylesheet" />
    <link href="<%=basePath%>resources/statics/simpleboot/font-awesome/4.2.0/css/font-awesome.min.css"  rel="stylesheet" type="text/css">
    <style>
	...
	<!--[if IE 7]>
	<link rel="stylesheet" href="<%=basePath%>resources/statics/simpleboot/font-awesome/4.2.0/css/font-awesome-ie7.min.css">
	<![endif]-->
<script type="text/javascript">
//全局变量
var GV = {
    DIMAUB: "<%=basePath%>resources/",
    JS_ROOT: "statics/js/",
    TOKEN: ""
};
</script>
<!-- Le javascript
    ...
    <script src="<%=basePath%>resources/statics/js/jquery.js"></script>
    <script src="<%=basePath%>resources/statics/js/wind.js"></script>
    <script src="<%=basePath%>resources/statics/simpleboot/bootstrap/js/bootstrap.min.js"></script>
<style>
...
.eidt_uphoto .no {
    background: url("<%=basePath%>resources/statics/images/upload_pic.jpg") no-repeat scroll center center #FBFBFB;
    border: 1px solid #CCCCCC;
    height: 98px;
    overflow: hidden;
    text-indent: -2000em;
...
.eidt_uphoto .del{
	...
	width:15px;
	height:15px;
	background:url("<%=basePath%>resources/statics/images/upload_del.png") no-repeat;
	right:1px;
	top:1px;
	overflow:hidden;
	text-indent:-2000em;
...
/*上传选择按钮*/
#btupload,.addnew{
	background: url("<%=basePath%>resources/statics/js/swfupload/images/swfBnt.png") no-repeat; float:left; margin-right:10px;width:75px; height:28px; line-height:28px;font-weight:700; color:#fff;
}
#btupload{ 
...
var swfu = '';
	$(document).ready(function(){
		Wind.use("swfupload",GV.DIMAUB+"/handlers.js",function(){
		      swfu = new SWFUpload({
			flash_url:"<%=basePath%>resources/statics/js/swfupload/swfupload.swf",
			upload_url:"<%=basePath%>stock/swfupload",
			file_post_name : "filedata",
			post_params:{
			  "jsessionid":"<%=request.getSession().getId()%>","id":"${id}"
			},
...
<div class="wrap" style="padding:5px;">
  ...
  <input type="hidden" id="return_data"/>
    ...
    <div class="pop_cont">
      <div class="">
        <div class="edit_uping"> 
            ...
            <span class="num">最多上传<em> 1</em> 个附件,单文件最大 <em>20240 KB</em>，<em style="cursor: help;" title="可上传格式：jpg,png,pdf">支持格式？</em></span>
        </div>
...
<script src="<%=basePath%>resources/statics/js/common.js"></script> 
<script>
$(function(){
    $("#att-status").html("");
    $("#att-status-del").html("");
