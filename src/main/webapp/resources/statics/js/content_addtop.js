...
function flashupload(uploadid, name, textareaid, funcName, args, module, catid, authkey) {
    ...
    console.log(GV.DIMAUB+'manager/article/swfupload?m=asset&g=asset' + args + setting);
    Wind.use("artDialog","iframeTools",function(){
        art.dialog.open(GV.DIMAUB+'manager/article/swfupload?m=asset&g=asset' + args + setting, {
        title: name,
        id: uploadid,
        width: '650px',
        height: '420px',
