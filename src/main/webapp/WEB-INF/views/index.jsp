...
$(function(){
	...
	setTimeout("clickgp();$('#shousuo').click();",500);
//	setInterval("clickgp()",15000);
...
<body scroll="no">
	<div id="layout">
		<div id="header">
			<div class="headerNav">&nbsp; 
				<span class="logo_text">豆豆工作系统</span>
				<ul class="nav">
					<li><a>欢迎您，豆豆</a></li>
				</ul>
			</div>
		...
		<div id="leftside">
			...
			<div id="sidebar">
				<div class="toggleCollapse"><h2>主菜单</h2><div id="shousuo">收缩</div></div>
