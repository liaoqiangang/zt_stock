...
public class AppendFile {
	...
	public static String addDate(String conent){
		return sdf.format(new Date())+"\t###\t"+conent+"\t###\r\n";
	}
    ...
    public static void method3(String fileName, String content) { 
        ...
        try {   
            ...
            randomFile.writeBytes(addDate(content));    
        } catch (IOException e) {   
            e.printStackTrace();   
        } finally{
        	if(randomFile != null){
